...
write_Sequence(hs_filtered_TxDb, case_5pUTR_tx, "UTR5", "LMB_analysis/LMB_case_longest_UTR52", "both")
write_Sequence(hs_filtered_TxDb, ctrl_5pUTR_tx, "UTR5", "LMB_analysis/LMB_ctrl_longest_UTR52", "both")

#longest CDS
case_CDS_tx <- gene2Tx(longest_hs, case_genes, "CDS")
ctrl_CDS_tx <- gene2Tx(longest_hs, ctrl_genes, "CDS")

write_Sequence(hs_filtered_TxDb, case_CDS_tx, "CDS", "LMB_analysis/LMB_case_longest_CDS2", "both")
write_Sequence(hs_filtered_TxDb, ctrl_CDS_tx, "CDS", "LMB_analysis/LMB_ctrl_longest_CDS2", "both")

#longest 3'UTR
case_3pUTR_tx <- gene2Tx(longest_hs, case_genes, "UTR3")
ctrl_3pUTR_tx <- gene2Tx(longest_hs, ctrl_genes, "UTR3")

write_Sequence(hs_filtered_TxDb, case_3pUTR_tx, "UTR3", "LMB_analysis/LMB_case_longest_UTR32", "both")
write_Sequence(hs_filtered_TxDb, ctrl_3pUTR_tx, "UTR3", "LMB_analysis/LMB_ctrl_longest_UTR32", "both")
...
case_5UTR <- readDNAStringSet("LMB_analysis/LMB_case_longest_UTR52.fa")
ctrl_5UTR <- readDNAStringSet("LMB_analysis/LMB_ctrl_longest_UTR52.fa")

case_CDS <- readDNAStringSet("LMB_analysis/LMB_case_longest_CDS2.fa")
ctrl_CDS <- readDNAStringSet("LMB_analysis/LMB_ctrl_longest_CDS2.fa")

case_3UTR <- readDNAStringSet("LMB_analysis/LMB_case_longest_UTR32.fa")
ctrl_3UTR <- readDNAStringSet("LMB_analysis/LMB_ctrl_longest_UTR32.fa")
...
#write.table(all_kmer$`5UTR_kmer`, "LMB_analysis/LMB_5UTR_6mercounts2.txt")
#write.table(all_kmer$`CDS_kmer`, "LMB_analysis/LMB_CDS_6mercounts2.txt")
#write.table(all_kmer$`3UTR_kmer`, "LMB_analysis/LMB_3UTR_6mercounts2.txt")
all_kmer <- list("5UTR_kmer" = tibble(read.table("LMB_analysis/LMB_5UTR_6mercounts2.txt")),
                 "CDS_kmer" = tibble(read.table("LMB_analysis/LMB_CDS_6mercounts2.txt")),
                 "3UTR_kmer" = tibble(read.table("LMB_analysis/LMB_3UTR_6mercounts2.txt")))
...
#write.table(CISBPRNA_hs_PWM_motif$`5UTR_cisbpRNA`, "LMB_analysis/LMB_5UTR_CISBPRNA_hs_PWM_motifcts2.txt")
#write.table(CISBPRNA_hs_PWM_motif$`CDS_cisbpRNA`, "LMB_analysis/LMB_CDS_CISBPRNA_hs_PWM_motifcts2.txt")
#write.table(CISBPRNA_hs_PWM_motif$`3UTR_cisbpRNA`, "LMB_analysis/LMB_3UTR_CISBPRNA_hs_PWM_motifcts2.txt")
all_cisbpRNA <- list("5UTR_cisbpRNA" = tibble(read.table("LMB_analysis/LMB_5UTR_CISBPRNA_hs_PWM_motifcts2.txt")),
                     "CDS_cisbpRNA" = tibble(read.table("LMB_analysis/LMB_CDS_CISBPRNA_hs_PWM_motifcts2.txt")),
                     "3UTR_cisbpRNA" = tibble(read.table("LMB_analysis/LMB_3UTR_CISBPRNA_hs_PWM_motifcts2.txt")))
...
#write.table(RBNS_PWM_motif$`5UTR_RBNS`, "LMB_analysis/LMB_5UTR_RBNS_PWM_motifcts2.txt")
#write.table(RBNS_PWM_motif$`CDS_RBNS`, "LMB_analysis/LMB_CDS_RBNS_PWM_motifcts2.txt")
#write.table(RBNS_PWM_motif$`3UTR_RBNS`, "LMB_analysis/LMB_3UTR_RBNS_PWM_motifcts2.txt")
all_RBNS <- list("5UTR_RBNS" = tibble(read.table("LMB_analysis/LMB_5UTR_RBNS_PWM_motifcts2.txt")),
                 "CDS_RBNS" = tibble(read.table("LMB_analysis/LMB_CDS_RBNS_PWM_motifcts2.txt")),
                 "3UTR_RBNS" = tibble(read.table("LMB_analysis/LMB_3UTR_RBNS_PWM_motifcts2.txt")))
```
